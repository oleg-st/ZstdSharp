            ...
            _match_stored:
                ...
                if (ip <= ilimit)
                {
                    ...
                    while (ip <= ilimit)
                    {
                        ...
                        if (prefixLowestIndex - 1 - repIndex2 >= 3 && MEM_read32(repMatch2) == MEM_read32(ip))
                        {
            ...
            while (ip < ilimit)
            {
                ...
                if (ip <= ilimit)
                {
                    ...
                    while (ip <= ilimit)
                    {
                        ...
                        if (prefixStartIndex - 1 - repIndex2 >= 3 && offset_2 <= current2 - dictStartIndex && MEM_read32(repMatch2) == MEM_read32(ip))
                        {
