...
namespace ZstdSharp.Unsafe
{
    public static unsafe partial class Methods
    {
        ...
        {
            if (streaming == streaming_operation.not_streaming && dstCapacity > (1 << 17) + 32 + litSize + 32)
            {
        ...
        public static readonly uint* dec32table = GetArrayPointer(new uint[8] { 0, 1, 2, 1, 4, 4, 4, 4 });
        public static readonly int* dec64table = GetArrayPointer(new int[8] { 8, 8, 8, 7, 8, 9, 10, 11 });
        /*! ZSTD_overlapCopy8() :
